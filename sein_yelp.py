...
def get_business_lat_lng(zip_code_search):
    """Query Yelp API for businesses according to search parameters."""
    ...
    for item in food_list:
        ...
        for biz in business_data['businesses']:
            ...
            biz_details = []
            biz_details.append(biz['coordinates']['longitude'])
            biz_details.append(biz['coordinates']['latitude'])

            business_lat_lng[biz['name']] = biz_details

    return business_lat_lng
